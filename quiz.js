...
for(var i=0;i<4;i++){
  ...
  document.querySelectorAll(".btn-light")[i].addEventListener("click",function(event){
    ...
    // document.getElementById(questionSet[quesno].answer).removeAttribute("enabled");
    // document.getElementById(questionSet[quesno].answer).className="disabled";
  ...
  document.querySelector(".next").addEventListener("click",function(){
    ...
    document.getElementById(questionSet[quesno].answer).hover=true;

    // document.getElementById(questionSet[quesno].answer).removeAttribute("disabled");
    // document.getElementById(questionSet[quesno].answer).className="enabled";
